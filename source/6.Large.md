...
## large-scale with many sample datasets.
...
## 2. Calculating Site–Gene Importance
...
epiFile="/home/wang/Tichr/202509tool/large/data/dhs.chr21.bed"
genefile="/home/wang/Tichr/202509tool/large/data/exp.chr21.bed"
hicFile="/home/common/rawdata/Hi-C_juicer_file/K562/ENCFF621AIY/ENCFF621AIY.hic"
#把HiC本地文件代替成encode的在线链接
gt="/home/wang/database/hg38/genome_table"

obj = largescale(epiFile, genefile, hicFile, gt, hicRes=25000)

obj.process(outname="out/testclass")
```
...
### 5.1 Site–Gene Importance

`testclass_Expon_importance.tsv`
...
### 5.2 Predicted Expression

`testclass_Expon_predicted.tsv`
...
df = pd.read_csv("~/Tichr/202509tool/large/out/testclass_predicted.tsv", sep="\t")

# Cell type annotations
cellDF = pd.read_csv("/home/wang/Tichr/datahub/EPdata/RED/hg19/celltype.tsv", sep="\t")
...
## 7.2 Dimensionality Reduction Function
...
h5 <- "/home/common/rawdata/singlecell_data/pbmc_granulocyte_sorted_10k_raw_feature_bc_matrix.h5"
