...
For most users, it is sufficient to refer to the core functions described in [here](1.Compute.md) and the command-line interface documentation in [here](CLI.md).
